...
const propertySchema = new mongoose.Schema(
  {
    ...
    city: {
      ...
      enum: {
        values: ['Mumbai', 'Delhi', 'Bangalore', 'Ahmedabad', 'Vadodara','Bihar','Uttar Pradesh'],
    ...
    listingType: {
      type: String,
      enum: { values: ['sale', 'rent'], message: 'Listing type must be sale or rent' },
      required: [true, 'Listing type is required'],
    },
    propertyType: {
      type: String,
      enum: { values: ['Flat', 'Villa', 'PG', 'Plot'], message: '{VALUE} is not a valid property type' },

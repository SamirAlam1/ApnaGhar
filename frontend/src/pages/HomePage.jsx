...
function SectionTitle({ badge, title, subtitle }) {
  return (
    <div className="text-center mb-10">
      ...
      <h2 className="font-display font-bold text-3xl sm:text-4xl text-gray-900 dark:text-white mb-3">
        {title}
      </h2>
      {subtitle && (
        ...
        <div className="flex items-center justify-between mb-10">
          ...
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">
              Hand-picked premium listings across India
            </p>
          </div>

          <Link
            to="/properties"
            className="hidden sm:flex items-center gap-2 text-blue-700 dark:text-blue-400 font-semibold"
          >
